                    ...
                    try {
                        ...
                        if (priceRange[0] > 0 || priceRange[1] < 10000) {
                            filtered = filtered.filter({
                                "ProductsPage.useEffect.fetchProducts": (p)=>p.price >= priceRange[0] && p.price <= priceRange[1]
                            }["ProductsPage.useEffect.fetchProducts"]);
                        }
                        if (inStockOnly) {
                            filtered = filtered.filter({
                                "ProductsPage.useEffect.fetchProducts": (p)=>p.inStock
                            }["ProductsPage.useEffect.fetchProducts"]);
                        }
...
_s(ProductsPage, "rreJtaCkMOdkpxTzJtgp4cCpZhk=", false, function() {
    return [
...
//# sourceMappingURL=_eedd59a0._.js.map
...
const useCartStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        getSubtotal: ()=>{
            return get().items.reduce((total, item)=>total + item.product.originalPrice * item.quantity, 0);
        },
        getDiscount: ()=>{
            return get().items.reduce((total, item)=>total + (item.product.originalPrice - item.product.price) * item.quantity, 0);
        },
        getTotal: ()=>{
...
function Header() {
    ...
    const { getItemCount, getTotal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCartStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setMounted(true);
    }, []);
    const itemCount = mounted ? getItemCount() : 0;
    const totalPrice = mounted ? getTotal() : 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43cc256c._.js.map